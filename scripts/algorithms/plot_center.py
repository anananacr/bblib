...
def main():
    parser = argparse.ArgumentParser(
        description="Plot calculated center distribution."
    )
    parser.add_argument(
        "-i",
        "--input",
    ...
    ax1.scatter(median_x, median_y, c='r', marker='X',s=50, label=f'median :{median_x, median_y}')             
    ax1.scatter(mean_x, mean_y, c='g', marker='s', s=50, label=f'mean :{mean_x, mean_y}')
    fig.legend()
    #plt.show()
