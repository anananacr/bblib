...
#SUB_FOLDER =$(basename $(dirname $INP))
#FOLDER =$(basename $(dirname $(dirname $INP)))
#mkdir $ROOT/$FOLDER;
#mkdir $ROOT/$SUB_FOLDER;
...
echo $MODE_NUMBER
beamtime=11016614
ROOT=/asap3/fs-bmx/gpfs/regae/2022/data/$beamtime/processed/test/converted
