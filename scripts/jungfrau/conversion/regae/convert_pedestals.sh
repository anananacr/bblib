...
MODE=$2
N=$(basename $INP)
beamtime=11016614 #11018148
OUTPUT=/asap3/fs-bmx/gpfs/regae/2022/data/$beamtime/processed/test/darks
echo $N

## convert start dark
ls /asap3/fs-bmx/gpfs/regae/2022/data/$beamtime/raw/${INP}*_start_pedal*_*d0_f*.h5>pedal_d0.lst
/home/rodria/software/om_dev_regae/om/bin_src/om_jungfrau_dark.py pedal_d0.lst ${OUTPUT}/pedal_d0_${N}_${MODE}_start.h5;

ls /asap3/fs-bmx/gpfs/regae/2022/data/$beamtime/raw/${INP}*_start_pedal*_*d1_f*.h5>pedal_d1.lst
